...
function plot_it() {
    ...
    var minfirst4Y = Math.min.apply(Math, nfl_data.map(function(d) {return d.first4_av; }))
    var maxfirst4Y = Math.max.apply(Math, nfl_data.map(function(d) {return d.first4_av; }))
